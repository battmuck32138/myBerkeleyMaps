...
/**
 * Go to localhost:4567 to use the program / run the server.
...
public class MapServer {
    ...
    */
    ...
    public static final int TILE_SIZE = 256; //Each tile is 256x256 pixels.
    private static final int HALT_RESPONSE = 403;  //HTTP failed response.
    ...
    public static final Color ROUTE_STROKE_COLOR = new Color(0, 230, 0, 200);
